    ...
    <ToastProvider placement='top-right' autoDismissTimeout='3000' autoDismiss='true'>
      <Router>
        <Switch>
          ...
          <Route exact path='/tutor/preferences'
            render={(props) => (
              <TutorDashboard {...props} extension='preferences'></TutorDashboard>
            )}></Route>
          <Route exact path='/tutor/settings'
            render={(props) => (
              <TutorDashboard {...props} extension='settings'></TutorDashboard>
            )}></Route>
          <Route exact path='/tutor/history'
            render={(props) => (
              <TutorDashboard {...props} extension='history'></TutorDashboard>
            )}></Route>
          <Route exact path='/tutor/analytics'
            render={(props) => (
              <TutorDashboard {...props} extension='analytics'></TutorDashboard>
            )}></Route>
          <Route exact path='/tutor/meetings'
            render={(props) => (
